...
_STATIC_ASSERT(sizeof(WMI_TRACE_PACKET) == sizeof(ULONG));
...
_STATIC_ASSERT(sizeof(WMI_TRACE_MESSAGE_PACKET) == sizeof(ULONG));
...
_STATIC_ASSERT(sizeof(WMI_BUFFER_HEADER) == 0x48);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferSize) == 0x0);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, SavedOffset) == 0x4);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, CurrentOffset) == 0x8);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, TimeStamp) == 0x10);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, SlistEntry) == 0x20);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, ClientContext) == 0x28);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, State) == 0x2c); // Compression
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, Offset) == 0x30);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferFlag) == 0x34);
_STATIC_ASSERT(FIELD_OFFSET(WMI_BUFFER_HEADER, BufferType) == 0x36);
...
_STATIC_ASSERT(PerfInfoMemUsageMax <= (1 << PERFINFO_MM_KERNELMEMORY_USAGE_TYPE_BITS));
...
_STATIC_ASSERT(PerfInfoMMStatMax <= (1 << PERFINFO_MM_STAT_TYPE_BITS));
...
_STATIC_ASSERT(PERFINFO_CCSWAP_BIT_FULL_TS == (32 - PERFINFO_CCSWAP_BIT_TYPE));

#define PERFINFO_CCSWAP_BIT_SHORT_TS    14
_STATIC_ASSERT(PERFINFO_CCSWAP_BIT_SHORT_TS == (16 - PERFINFO_CCSWAP_BIT_TYPE));

#define PERFINFO_CCSWAP_BIT_SMALL_TS    17
_STATIC_ASSERT(PERFINFO_CCSWAP_BIT_SMALL_TS ==
...
_STATIC_ASSERT(PERFINFO_CCSWAP_BIT_WAIT_TIME ==
