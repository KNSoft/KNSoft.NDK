...
#define SID_WORLD { SID_REVISION, 1, SECURITY_WORLD_SID_AUTHORITY, { SECURITY_WORLD_RID } }
#define SID_EVERYONE SID_WORLD
...
#define SID_ANONYMOUS_LOGON { SID_REVISION, 1, SECURITY_NT_AUTHORITY, { SECURITY_ANONYMOUS_LOGON_RID } }
#define SID_PROXY { SID_REVISION, 1, SECURITY_NT_AUTHORITY, { SECURITY_PROXY_RID } }
#define SID_ENTERPRISE_CONTROLLERS { SID_REVISION, 1, SECURITY_NT_AUTHORITY, { SECURITY_ENTERPRISE_CONTROLLERS_RID } }
...
#define SID_TERMINAL_SERVER { SID_REVISION, 1, SECURITY_NT_AUTHORITY, { SECURITY_TERMINAL_SERVER_RID } }
#define SID_REMOTE_LOGON { SID_REVISION, 1, SECURITY_NT_AUTHORITY, { SECURITY_REMOTE_LOGON_RID } }
...
#define SID_GUESTS { { SID_REVISION, 2, SECURITY_NT_AUTHORITY, { SECURITY_BUILTIN_DOMAIN_RID } }, DOMAIN_ALIAS_RID_GUESTS }
