...
// rev
/**
 * The NtWaitForAlertByThreadId routine blocks the calling thread until another thread calls
 * NtAlertThreadByThreadId with a matching address, or until the timeout expires.
 *
