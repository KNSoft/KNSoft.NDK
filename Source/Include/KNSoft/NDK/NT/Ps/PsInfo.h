...
typedef enum _THREADINFOCLASS
{
    ...
    ThreadStrongerBadHandleChecks,                  // qs: ULONG // NtCurrentThread
...
//
// NtSetInformationProcess(ProcessEnergyTrackingState) only accepts
// PROCESS_ENERGY_STATE_PSM_FOREGROUND, while
// NtQueryInformationProcess(ProcessEnergyTrackingState) may return
// FOREGROUND, DESKTOP_VISIBLE, and PSM_FOREGROUND combinations.
//
