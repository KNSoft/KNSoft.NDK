...
#define NT_VERSION_WINXP_X64 NT_VERSION_WS2K3
...
#pragma message("KNSoft.NDK: NT_VERSION_MIN is below NT_VERSION_MIN_CONSTRAINED; using NT_VERSION_MIN_CONSTRAINED.")
