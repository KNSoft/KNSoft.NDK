...
TEST_FUNC(StrSafeFunc)
{
    ...
    TEST_OK(StrSafe_CchPrintfA(NULL, 0, "%hs", TEST_STRING1_A) == _STR_CCH_LEN(TEST_STRING1_A) + 1);
    ...
    TEST_OK(StrSafe_CchPrintfW(NULL, 0, L"%ls", TEST_STRING1_W) == _STR_CCH_LEN(TEST_STRING1_W) + 1);
    ...
    TEST_OK(StrSafe_CchPrintfA(NULL, 0, "%hs$$", TEST_STRING1_A) == _STR_CCH_LEN(TEST_STRING1_A) + 3);
    ...
    TEST_OK(StrSafe_CchPrintfW(NULL, 0, L"%ls$$", TEST_STRING1_W) == _STR_CCH_LEN(TEST_STRING1_W) + 3);
